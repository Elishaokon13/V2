...
const Header= () => {
  ...
  return (
    <header className='padding-x' style={{ height: '107px', width: '100%' }}>
      ...
      <button
        id='walletButton'
        onClick={connected ? claim : connectWallet}
        className={connected ? 'claim-button' : 'connect-button'}
      >
        {claimButtonLabel}
      </button>
    </header>
